...
int main()
{
	...
	LinearStandardOpenHashTable<int>* test = new LinearStandardOpenHashTable<int>(11);
	test->insertKey(72)->insertKey(90)->deleteKey(72);
	cout << test->searchKey(4) << endl;;

	LinearStandardOpenHashTable<int>* LOHtable = new LinearStandardOpenHashTable<int>(11);
	...
	LinearNonStandardOpenHashTable<int>* LEOHtable = new LinearNonStandardOpenHashTable<int>(11);
	...
	QuadraticNonStandardOpenHashTable<int>* QEOHtable = new QuadraticNonStandardOpenHashTable<int>(11);
